...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="talking_wah_core2" -proc ADSP-SC589 -si-revision 1.0 -g -DCORE2 -D_DEBUG @includes-2c69e2e482752a7443b028fa48af04ac.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="talking_wah_core2" -proc ADSP-SC589 -si-revision 1.0 -g -DCORE2 -D_DEBUG @includes-2c69e2e482752a7443b028fa48af04ac.txt -swc -char-size-8 -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
