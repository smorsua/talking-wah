...
src/audio_processing/audio_elements/allpass_filter.doj: C:/Users/acustica/Documents/smorsua/talking-wah/cc_workspace/talking_wah/audio_processing/audio_elements/allpass_filter.c
	...
	cc21k -c -file-attr ProjectName="talking_wah_core2" -proc ADSP-SC589 -flags-compiler --no_wrap_diagnostics -si-revision 1.0 -O -Ov100 -g -DCORE2 -D_DEBUG @includes-1d4f3bb45db67787308fcb8b1ec6b881.txt -structs-do-not-overlap -no-const-strings -no-multiline -warn-protos -double-size-32 -char-size-8 -swc -gnu-style-dependencies -MD -Mo "src/audio_processing/audio_elements/allpass_filter.d" -o "$@" "$<"
